...
using SsmsExtensions.Commands;
using Task = System.Threading.Tasks.Task;

namespace SsmsExtensions;
...
public sealed class SsmsExtensionsPackage : AsyncPackage
{
    /// <summary>
    ///     SsmsExtensionsPackage GUID string.
    /// </summary>
    ...
    protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
    {
        ...
        await ConvertExecuteStatementsCommand.InitializeAsync(this);
